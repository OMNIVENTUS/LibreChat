...
export enum PermissionTypes {
  ...
  // [OMNIVENTUS-START]
  /**
   * Type for User Admin Permissions (user administration feature)
   */
...
export const PERMISSION_TYPE_INTERFACE_FIELDS: Record<PermissionTypes, string> = {
  ...
  // [OMNIVENTUS] no interface config field; managed via role permissions only
  [PermissionTypes.USER_ADMIN]: 'userAdmin',
};
