...
import {
  ...
  ArrowRightToLine,
  SlidersHorizontal,
  // [OMNIVENTUS] user administration nav icon
  Users,
} from 'lucide-react';
import {
  Permissions,
...
// [OMNIVENTUS] user administration panel
...
export default function useSideNavLinks({
  ...
  // [OMNIVENTUS] user administration access
  ...
  const Links = useMemo(() => {
    ...
    // [OMNIVENTUS] user administration panel link
