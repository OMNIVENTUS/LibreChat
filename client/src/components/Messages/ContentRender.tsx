...
// [OMNIVENTUS] business actions rendered above AI responses
import BusinessActionsCard from '~/components/Chat/Messages/ui/BusinessActionsCard';
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <div className="flex min-h-[20px] max-w-full flex-grow flex-col gap-0">
            {/* [OMNIVENTUS] business actions above the AI response */}
            <BusinessActionsCard
              actions={(msg as TMessage & { contextualActions?: [] })?.contextualActions || []}
              messageId={msg.messageId}
              isLoading={false}
            />
            <ContentParts
