...
export function DataTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-end gap-2" role="navigation" aria-label="Pagination">
        <div className="text-sm text-muted-foreground">
          {localize('com_users_total_records', { count: table.getFilteredRowModel().rows.length })}
        </div>
        <Button
          variant="outline"
          size="sm"
